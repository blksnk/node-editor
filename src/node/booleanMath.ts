...
export class AndBooleanMathNode extends BooleanMathNode {
  constructor() {
    const operation: NodeOperation<boolean, 'boolean'> = ([ a, b ]: NodeOperationArgument<boolean, 'boolean'>[]) => {
      return {
        name: 'Result',
        type: 'boolean',
...
export class NotBooleanMathNode extends Node<boolean, 'boolean'> {
  constructor() {
    ...
    const operation: NodeOperation<boolean, 'boolean'> = ([ v ]: NodeOperationArgument<boolean, 'boolean'>[]) => {
      return {
        name: 'Result',
        type: 'boolean',
        value: !v.value
